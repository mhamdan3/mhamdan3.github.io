<?php
  ...
  $captcha_post_data = http_build_query(array('secret' => getenv('6LcRy1AUAAAAAJM9k4QZLrCpDj_4M71tl2Q4PSD8'), 'response' => $_POST["g-recaptcha-response"]));
  ...
  if (!getenv('FEEDBACK_SKIP_AUTH')) {
    $mail->SMTPAuth = true;
    $mail->Username = getenv('mahdi.hamdan143@gmail.com');
    $mail->Password = getenv('snutqw5v');
  }
  ...
  $mail->Sender = getenv('mahdi.hamdan143@gmail.com');
  $mail->setFrom($_POST['email'], $_POST['name']);
  $mail->addAddress(getenv('mahdi.hamdan143@gmail.com'));
